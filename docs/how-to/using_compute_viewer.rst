...
The ISA view is available under "Compute Unit" and "Utilization" tab. a list of instructions along with their "Hitcount" and "Latency" cost. If debug symbols are present, ``rocprofv3`` snapshots the related source files, as shown on the right side of the image.
